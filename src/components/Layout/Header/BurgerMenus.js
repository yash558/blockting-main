            ...
            <div className="side-info-content">
                <div className="mm-menu">
                  ...
                  <li><Link href="/contact"><a>Contact</a></Link></li>
                    ...
                    {/* <li className={project ? "has-droupdown active" : "has-droupdown"}>
                      <a onClick={() => { openMobileMenu('project'); }}>Portfolio</a>
                    ...
                    {/* <li className={pages ? "has-droupdown active" : "has-droupdown"}>
                      <a onClick={() => { openMobileMenu('pages'); }}>Contact</a>
                ...
                <div className="contact-infos mb-30">
                    <div className="contact-list mb-30">
                        <h4>Contact Info</h4>
                        <ul>
                            <li><img src="assets/img/icon/sidebar-icon-1.png" className="img-fluid" alt="icon-img"/>82 Mohinder, Thakur Singh Colony Rd
Jalandhar Cantt, Jalandhar, Punjab (IN) 144005</li>
                            <li><img src="assets/img/icon/footer-icon-1.png" className="img-fluid" alt="icon-img"/><a href="mailto:info@sycho24.com">hi@blockting.com</a></li>
