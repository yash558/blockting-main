                        ...
                        <div className="swiper-wrapper">
                                ...
                                <div className="ktestimonial mb-30 swiper-slides">
                                    ...
                                    <div className="ktestimonial-author">
                                        <div className="ktestimonial-author-img">
                                            <img src="assets/img/img4.jpg" height={80} width={80} className="img-fluid" alt="client-img"/>
                                        </div>
                            ...
                            <SwiperSlide>
                                <div className="ktestimonial mb-30 swiper-slides">
                                    ...
                                    <div className="ktestimonial-author">
                                        <div className="ktestimonial-author-img">
                                            <img src="assets/img/img5.jpg"  height={80} width={80} className="img-fluid" alt="client-img"/>
                                        </div>
                                        <div className="ktestimonial-author-text">
